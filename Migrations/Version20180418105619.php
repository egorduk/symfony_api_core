 ...
 */
class Version20180418105619 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
            ...
            <table align="center" style="background:#ffffff;width:600px;margin:0 auto;font-size:16px;color:#333333;border-spacing:0;border-collapse:collapse">
                ...
                <tr>
                    <td style="padding:15px 10px;text-align:center;line-height:24px">
                        <div style="color:#777777">Voucher was created:</div>
                        <div style="font-size:20px">{{ voucher.code }}</div>
                    </td>
                </tr>
                <tr>
...
EOC;
        ...
        $sql = <<< EOC
INSERT INTO `email_template` (`description`, `body`, `name`, `subject`, `created_at`, `updated_at`) VALUES ('<p>Available template variables:</p><ul><li><strong>{{ voucher.code }}</strong> - platform </li></ul>', $emailTpl, 'voucher.issue', 'Voucher Issue', '2017-09-27 12:45:36', '2017-09-27 12:45:36');
EOC;
        $this->addSql($sql);
    ...
    <tr>
        <td align="center" style="padding:0 10px">
            <table align="center" style="background:#ffffff;width:600px;margin:0 auto;font-size:16px;color:#333333;border-spacing:0;border-collapse:collapse">
                ...
                <tr>
                    <td style="padding:15px 10px;text-align:center;line-height:24px">
                        <div style="color:#777777">Voucher was redeemed:</div>
                        <div style="font-size:20px">{{ voucher.code }}</div>
                    </td>
                </tr>
                <tr>
...
EOC;
        ...
        $emailTpl = $this->connection->quote($emailTpl);
        $sql = <<< EOC
INSERT INTO `email_template` (`description`, `body`, `name`, `subject`, `created_at`, `updated_at`) VALUES ('<p>Available template variables:</p><ul><li><strong>{{ voucher.code }}</strong> - platform </li></ul>', $emailTpl, 'voucher.redeem', 'Voucher Redeem', '2017-09-27 12:45:36', '2017-09-27 12:45:36');
EOC;
        $this->addSql($sql);
    }
