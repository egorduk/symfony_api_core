 ...
 */
class Version20180504151212 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DELETE FROM `email_template` WHERE `name` = \'user.verification.approved\'');
    ...
    <tr>
        <td align="center" style="padding:0 10px">
            <table align="center" style="background:#ffffff;width:600px;margin:0 auto;font-size:16px;color:#333333;border-spacing:0;border-collapse:collapse">
                <tbody>
                <tr>
                    <td style="padding:140px 10px 50px;text-align:center;line-height:50px;vertical-align:top;font-size:56px;font-weight:bold;text-transform:uppercase">Notification</td>
                </tr>
                <tr>
                    <td style="padding:15px 10px;text-align:center;line-height:24px">
                        <div style="color:#777777">Your verification was approved</div>
                    </td>
                </tr>
                <tr>
...
EOC;
        ...
        $sql = <<< EOC
INSERT INTO `email_template` (`description`, `body`, `name`, `subject`, `created_at`, `updated_at`) VALUES ('', $emailTpl, 'user.verification.approved', 'Verification approved', '2017-09-27 12:45:36', '2017-09-27 12:45:36');
EOC;
        $this->addSql($sql);

        $this->addSql('DELETE FROM `email_template` WHERE `name` = \'user.verification.denied\'');
    ...
    <tr>
        <td align="center" style="padding:0 10px">
            <table align="center" style="background:#ffffff;width:600px;margin:0 auto;font-size:16px;color:#333333;border-spacing:0;border-collapse:collapse">
                ...
                <tr>
                    <td style="padding:15px 10px;text-align:center;line-height:24px">
                        <div style="color:#777777">Your verification was denied</div>
                        <div style="font-size:20px">Reason: {{ reasonDeclined }}</div>
                    </td>
                </tr>
                <tr>
                    <td style="padding:0 10px 50px;text-align:center;line-height:20px">
...
EOC;
        ...
        $emailTpl = $this->connection->quote($emailTpl);
        $sql = <<< EOC
INSERT INTO `email_template` (`description`, `body`, `name`, `subject`, `created_at`, `updated_at`) VALUES ('<p>Available template variables:</p><ul><li><strong>{{ reasonDeclined }}</strong></li></ul>', $emailTpl, 'user.verification.denied', 'Verification denied', '2017-09-27 12:45:36', '2017-09-27 12:45:36');
EOC;
        $this->addSql($sql);
    }
